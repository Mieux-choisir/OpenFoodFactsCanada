...
class CsvCreator:
    def __init__(self, csv_files_base_names):
        ...
        self.product_field_to_columns_mapping = {
            ...
            "nutrition_facts.nutrition_facts_per_hundred_grams.energy_100g": "Energy (kJ) for 100 g / 100 ml",
            ...
            "nutrition_facts.nutrition_facts_per_serving.energy_serving": "Energy (kJ) per serving",
