...
def test_should_return_round_down_int_with_given_float_score_value_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [46.7]
    ...
    with patch.object(IngredientsOriginMapper,
                      'map_off_row_to_ingredients_origin',
                      return_value=origins):
        with patch.object(PackagingMapper,
                          'map_off_row_to_packaging',
                          return_value=packaging):
            with patch.object(ProductionSystemMapper,
    ...
    assert (
            result.score == 46
    ), f"Expected score of {46}, got {result.score}"


def test_should_return_correct_given_int_score_value_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [18]
    header = ["environmental_score_score"]
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
    ...
    assert (
            result.score == 18
    ), f"Expected score of {18}, got {result.score}"


def test_should_return_correct_origins_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [18]
    header = ["environmental_score_score"]
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
...
def test_should_return_correct_packaging_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [18]
    header = ["environmental_score_score"]
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
...
def test_should_return_correct_production_system_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [18]
    header = ["environmental_score_score"]
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
...
def test_should_return_empty_threatened_species_in_ecoscore_data_for_given_off_row(ecoscore_data_mapper):
    row = [18]
    header = ["environmental_score_score"]
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
...
def test_should_return_round_down_int_with_given_float_score_value_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
...
def test_should_return_correct_given_int_score_value_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
...
def test_should_return_correct_origins_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
    off_doc = {"environmental_score_score": 18}
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
    production_system = MagicMock(spec=ProductionSystem)
...
def test_should_return_correct_packaging_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
    off_doc = {"environmental_score_score": 18}
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
    production_system = MagicMock(spec=ProductionSystem)
...
def test_should_return_correct_production_system_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
    off_doc = {"environmental_score_score": 18}
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
    production_system = MagicMock(spec=ProductionSystem)
...
def test_should_return_empty_threatened_species_in_ecoscore_data_for_given_off_dict(ecoscore_data_mapper):
    off_doc = {"environmental_score_score": 18}
    origins = IngredientsOrigins(origins=["Canada"], percent="50", transportation_score="4")
    packaging = MagicMock(spec=Packaging)
    production_system = MagicMock(spec=ProductionSystem)
