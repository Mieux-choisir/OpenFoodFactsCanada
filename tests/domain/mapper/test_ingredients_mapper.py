...
def test_should_return_ingredients_text_in_title_format_in_ingredients_for_given_fdc_dict(ingredients_mapper):
...
def test_should_return_ingredients_list_from_ingredients_normalizer_in_ingredients_for_given_fdc_dict(ingredients_mapper):
    ingredients = "FLOUR, SUGAR, PEANUTS."
    ingredients_list = ["Flour", "sugar", "Peanuts"]
    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.return_value = ingredients_list
...
def test_should_correctly_call_ingredients_normalizer_for_given_fdc_dict(ingredients_mapper):
    ingredients = "FLOUR, SUGAR, PEANUTS."

    ingredients_mapper.map_fdc_dict_to_ingredients(ingredients)

    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.assert_called_with(ingredients)
...
def test_should_return_ingredients_text_in_title_format_in_ingredients_for_given_off_row(ingredients_mapper):
...
def test_should_return_ingredients_list_from_ingredients_normalizer_in_ingredients_for_given_off_row(ingredients_mapper):
    row = ["FLOUR, SUGAR, PEANUTS."]
    header = ["ingredients_text"]
    ingredients_list = ["Flour", "sugar", "Peanuts"]
    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.return_value = ingredients_list
...
def test_should_correctly_call_ingredients_normalizer_for_given_off_row(ingredients_mapper):
    row = ["FLOUR, SUGAR, PEANUTS."]
    header = ["ingredients_text"]

    ingredients_mapper.map_off_row_to_ingredients(row, header)

    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.assert_called_with(row[0])
...
def test_should_return_ingredients_text_in_title_format_in_ingredients_for_given_off_dict(ingredients_mapper):
...
def test_should_return_ingredients_list_from_ingredients_normalizer_in_ingredients_for_given_off_dict(ingredients_mapper):
    off_dict = {"ingredients_text": "FLOUR, SUGAR, PEANUTS."}
    ingredients_list = ["Flour", "sugar", "Peanuts"]
    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.return_value = ingredients_list
...
def test_should_correctly_call_ingredients_normalizer_for_given_off_dict(ingredients_mapper):
    off_dict = {"ingredients_text": "FLOUR, SUGAR, PEANUTS."}

    ingredients_mapper.map_off_dict_to_ingredients(off_dict)

    ingredients_mapper.ingredient_normalizer.normalise_ingredients_list.assert_called_with(off_dict["ingredients_text"])
