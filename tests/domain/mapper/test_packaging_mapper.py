...
def test_should_return_empty_non_recyclable_field_in_packaging_for_given_off_row(packaging_mapper):
...
def test_should_return_correctly_split_string_in_packaging_field_in_packaging_for_given_off_row(packaging_mapper):
    row = ["plastic, bottle, , glass,"]
    header = ["packaging"]
...
def test_should_return_empty_list_for_empty_string_in_packaging_field_in_packaging_for_given_off_row(packaging_mapper):
    row = [""]
    header = ["packaging"]
...
def test_should_return_empty_non_recyclable_field_in_packaging_for_given_off_dict(packaging_mapper):
...
def test_should_return_given_list_in_packaging_field_in_packaging_for_given_off_dict(packaging_mapper):
    off_dict = {"packaging_tags": ["en:plastic", "en:bottle", "en:glass"]}
...
def test_should_return_empty_list_for_absent_value_in_packaging_field_in_packaging_for_given_off_dict(packaging_mapper):
